...
export default function WebhookVerlaufPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Webhook-Verlauf</h1>
      ...
      <div className="space-y-2">
        {executions.map((exec) => (
          <Link key={exec.id} href={`/integrationen/webhooks/verlauf/${exec.id}`}>
