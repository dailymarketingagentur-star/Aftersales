...
export default function NeueWebhookSequenzPage() {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/integrationen/webhooks/sequenzen/${seq.id}`);
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Neue Webhook-Sequenz</h1>
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <Input id="slug" value={slug} onChange={(e) => setSlug(e.target.value)} required placeholder="meine-webhook-sequenz" />
              </div>
            </div>
            <div>
