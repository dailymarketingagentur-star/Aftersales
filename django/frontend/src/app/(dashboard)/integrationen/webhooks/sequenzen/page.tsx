...
export default function WebhookSequenzenPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Webhook-Sequenzen</h1>
      ...
      <div className="space-y-3">
        {sequences.map((seq) => (
          <Link key={seq.id} href={`/integrationen/webhooks/sequenzen/${seq.id}`}>
